...
#define IS_VBLANK                   (1 << 0)
#define IS_HBLANK                   (1 << 1)
#define IS_VCOUNT_MATCH             (1 << 2)
#define IS_TIMER_0                  (1 << 3)
#define IS_TIMER_1                  (1 << 4)
#define IS_TIMER_2                  (1 << 5)
#define IS_TIMER_3                  (1 << 6)
#define IS_DMA_0                    (1 << 8)
#define IS_DMA_1                    (1 << 9)
#define IS_DMA_2                    (1 << 10)
#define IS_DMA_3                    (1 << 11)
#define IS_KEYPAD                   (1 << 12)
#define IS_SLOT_2                   (1 << 13)
#define IS_IPC_SYNC                 (1 << 16)
#define IS_IPC_SEND_FIFO_EMPTY      (1 << 17)
#define IS_IPC_RECV_FIFO_NOT_EMPTY  (1 << 18)
#define IS_SLOT_1_TRANSFER_COMPLETE (1 << 19)
#define IS_SLOT_1_IREQ_MC           (1 << 20)
#define IS_GEOMETRY_COMMAND_FIFO    (1 << 21)
